## dataset
[ -z "${dataset}" ] && dataset=n1_network_train_yn
...
## savedir
[ -z "${path_to_sft_checkpoint}" ] && path_to_sft_checkpoint=/savedir/adapter/n1_network_llama13
[ -z "${path_to_predict_result}" ] && path_to_predict_result=/savedir/predict_results/n1_network_llama13
