## dataset
[ -z "${dataset}" ] && dataset=cellAnno_MS_train
...
## savedir
[ -z "${path_to_sft_checkpoint}" ] && path_to_sft_checkpoint=/savedir/adapter/cellAnno_ms_llama13
[ -z "${path_to_predict_result}" ] && path_to_predict_result=/savedir/predict_results/cellAnno_ms_llama13
