## dataset
[ -z "${dataset}" ] && dataset=cellAnno_MS_plus_train
...
## savedir
[ -z "${path_to_sft_checkpoint}" ] && path_to_sft_checkpoint=/savedir/adapter/cellAnno_ms_plus_llama13
[ -z "${path_to_predict_result}" ] && path_to_predict_result=/savedir/predict_results/cellAnno_ms_plus_llama13

## config
[ -z "${batch_size}" ] && batch_size=16
[ -z "${gradient_accumulation_steps}" ] && gradient_accumulation_steps=1
[ -z "${num_train_epochs}" ] && num_train_epochs=30
