## dataset 
[ -z "${dataset}" ] && dataset=bivalent_lys4_train
...
## savedir
[ -z "${path_to_sft_checkpoint}" ] && path_to_sft_checkpoint=/savedir/adapter/bivalent_lys4_llama13
[ -z "${path_to_predict_result}" ] && path_to_predict_result=/savedir/predict_results/bivalent_lys4_llama13
