## dataset
[ -z "${dataset}" ] && dataset=n1_target_train_yn
...
## savedir
[ -z "${path_to_sft_checkpoint}" ] && path_to_sft_checkpoint=/savedir/adapter/n1_target_llama13
[ -z "${path_to_predict_result}" ] && path_to_predict_result=/savedir/predict_results/n1_target_llama13
