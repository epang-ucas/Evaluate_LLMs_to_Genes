## dataset
[ -z "${dataset}" ] && dataset=dosage_train
...
## savedir
[ -z "${path_to_sft_checkpoint}" ] && path_to_sft_checkpoint=/savedir/adapter/dosage_llama13
[ -z "${path_to_predict_result}" ] && path_to_predict_result=/savedir/predict_results/dosage_llama13
